...
void draw_newgame_language(pmenudata data)
{
  ...
  for (a=0;a<playernum;a++)
  {
    ...
    {
      case 0: sprintf(buffer1,"Primäre Sprache wählen:"); break;
      case 1: sprintf(buffer1,"Sekundäre Sprache wählen:"); break;
      case 2: sprintf(buffer1,"Tertiäre Sprache wählen:"); break;
